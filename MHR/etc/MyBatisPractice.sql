...
INSERT INTO employee (emp_name, emp_name_kana, emp_age, emp_hiredate, dept_id)
VALUES
		('田中太郎', 'たなかたろう', 30, '2022-01-15', 1)
	,	('山田花子', 'やまだはなこ', 28, '2022-02-20', 2)
	,	('鈴木健太', 'すずきけんた', 35, '2021-12-10', 1)
	,	('佐藤美晴', 'さとうみはる', 25, '2023-03-05', 3)
	,	('伊藤健二', 'いとうけんじ', 32, '2022-07-18', 2)
	,	('渡辺奈美', 'わたなべなみ', 29, '2022-09-03', 1)
	,	('田村雅史', 'たむらまさふみ', 33, '2022-04-25', 3)
	,	('中島愛美', 'なかじままなみ', 27, '2021-11-30', 2)
	,	('小林隆夫', 'こばやしたかお', 31, '2022-08-14', 1)
	,	('加藤智子', 'かとうともこ', 26, '2023-01-22', 3)
	,	('山口直人', 'やまぐちなおと', 34, '2022-06-08', 2)
	,	('松本理恵', 'まつもとりえ', 30, '2022-03-12', 1)
	,	('井上和也', 'いのうえかずや', 28, '2022-05-29', 3)
	,	('木村美穂', 'きむらみほ', 29, '2021-10-07', 2)
	,	('佐々木修司', 'ささきしゅうじ', 32, '2022-12-01', 1)
	,	('岡田さやか', 'おかださやか', 27, '2023-02-10', 3)
	,	('三浦茂', 'みうらしげる', 33, '2022-07-25', 2)
	,	('高橋智子', 'たかはしたむこ', 31, '2022-09-18', 1)
	,	('田辺健一', 'たなべけんいち', 28, '2022-04-15', 3)
	,	('村田望', 'むらたのぞみ', 30, '2022-11-05', 2);
